                                    ...
                                    <div className='col-lg-4 col-md-6 col-sm-6 mb-3 position-relative' key={index}>
                                        <div className='work_drop'>
                                            <DropdownButton
                                                ...
                                                className=''
                                            >
                                                <Link eventKey="1" to={`/week-goals-details/${value.id}`} state={{ goalId: goal.id, goalLeadCumm: goal.lead_actual, goalLagCumm: goal.lag_actual }} className='dropdown-item'>View</Link>
